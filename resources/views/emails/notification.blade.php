                        ...
                        <td style="padding:40px;color:#333333;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="font-size:15px;line-height:1.6;">
                                <tr>
                                    ...
                                    <td style="padding:8px 0;color:#333;">: {{ $contact['nama_lengkap'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0;color:#666;font-weight:600;">Email</td>
                                    <td style="padding:8px 0;color:#333;">: <a href="mailto:{{ $contact['email'] }}" style="color:#8C1007;text-decoration:none;">{{ $contact['email'] }}</a></td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0;color:#666;font-weight:600;">Nomor Telepon</td>
                                    <td style="padding:8px 0;color:#333;">: {{ $contact['nomor_telepon'] }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0;color:#666;font-weight:600;">Asal Paroki</td>
                                    <td style="padding:8px 0;color:#333;">: {{ $contact['asal_paroki'] ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px 0;color:#666;font-weight:600;">Asal Lingkungan</td>
                                    <td style="padding:8px 0;color:#333;">: {{ $contact['asal_lingkungan'] ?? '-' }}</td>
                                </tr>
                            </table>

                            <div style="margin-top:25px;background-color:#FFF8F8;border-left: 4px solid #8C1007;padding:20px;border-radius:4px;">
                                <p style="margin:0 0 10px 0;font-weight:bold;color:#8C1007;font-size:14px;text-transform:uppercase;">Isi Pesan:</p>
