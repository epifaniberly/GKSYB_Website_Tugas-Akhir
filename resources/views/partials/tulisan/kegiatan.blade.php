<section class="w-full py-10 md:py-16 fs-style-manrope bg-[#FCFAF7]" data-aos="fade-up">
    <div class="container mx-auto px-6 md:px-16 lg:px-24 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-start mb-10">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-semibold leading-tight md:leading-snug text-[#3A0D0D] mb-2 text-center md:text-left">
                Agenda Kegiatan<br class="hidden md:block">
                Gereja Bintaran
            </h2>

            <div class="text-center md:text-left">
                <p class="text-[#3A0D0D] opacity-80 text-sm md:text-lg max-w-md mx-auto md:ml-auto leading-relaxed">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 bg-white rounded-[2rem] md:rounded-[2.5rem] overflow-hidden shadow-sm border border-gray-100">
                            ...
                            <div class="p-8 md:p-16 flex flex-col justify-center bg-white">
                                <div class="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
                                    ...
                                    <span class="text-[10px] md:text-sm text-[#3A0D0D]/40 tracking-tight">• {{ $item->created_at->translatedFormat('d M Y') }}</span>
                                </div>
                                ...
                                <p class="text-[#3b0d0d]/70 text-xs md:text-lg font-light leading-relaxed line-clamp-3 md:line-clamp-5">
                                    {{ $item->ringkasan }}
                                </p>
                            </div>
                        </div>
