<div id="modalDetail" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-4xl rounded-2xl shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
            <div>
                <h3 class="text-lg font-semibold text-gray-800">Detail Intensi</h3>
                <p class="text-xs text-gray-400 mt-0.5">Informasi lengkap intensi doa yang diterima</p>
            </div>
            <button onclick="hideDetail()" class="p-1.5 rounded-lg hover:bg-gray-50 text-gray-400 hover:text-gray-600 transition-colors focus:outline-none">
        ...
        <div class="p-6 space-y-6 overflow-y-auto max-h-[75vh] custom-scrollbar">
            <div>
                <label class="block text-sm font-semibold text-gray-800 mb-1.5">Nama Pengirim (Lengkap)</label>
                <p id="d_nama" class="text-[13px] font-semibold text-gray-800"></p>
            </div>
            <div class="grid grid-cols-2 gap-y-4 gap-x-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Asal Paroki</label>
                    <p id="d_asal_paroki" class="text-[13px] text-gray-600 truncate"></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Asal Lingkungan</label>
                    <p id="d_asal_lingkungan" class="text-[13px] text-gray-600"></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Jenis Permohonan</label>
                    <p id="d_jenis_permohonan" class="text-[13px] text-gray-600"></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Tanggal Intensi</label>
                    <p id="d_tgl_intensi" class="text-[13px] text-gray-600"></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Jadwal Misa</label>
                    <p id="d_jadwal_misa" class="text-[13px] text-gray-600"></p>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-800 mb-1.5">Status</label>
                    <div id="d_status_badge"></div>
                </div>
            </div>
            <div class="pt-2">
                <label class="block text-sm font-semibold text-gray-800 mb-1.5">Isi Intensi Doa</label>
                <div class="bg-gray-50 rounded-xl p-3.5 text-gray-700 text-[13px] leading-relaxed border border-gray-100">
                    <p id="d_isi" class="italic"></p>
                </div>
            </div>
        </div>
    </div>
...
<div id="modalEdit" class="fixed inset-0 z-50 hidden items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
            <h3 class="text-lg font-semibold text-gray-800">Update Status Doa</h3>
            <p class="text-[11px] text-gray-500 mt-0.5">Tentukan apakah doa sudah didoakan atau belum</p>
        </div>
        ...
        <form id="formStatus" method="POST" class="p-0 m-0">
            ...
            <div class="p-6">
                <label class="block text-sm font-semibold text-gray-800 mb-2">Status Pemrosesan <span class="text-red-500">*</span></label>
                <div class="relative">
