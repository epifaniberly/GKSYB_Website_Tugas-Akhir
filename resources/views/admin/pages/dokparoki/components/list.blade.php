<div class="space-y-4">
    ...
    <div class="bg-white border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row gap-6 hover:border-gray-300 transition-colors items-start fs-style-manrope">
        <div class="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center shrink-0">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M16 13H8" stroke="#EF4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M16 17H8" stroke="#EF4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10 9H9H8" stroke="#EF4444" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        ...
        <div class="flex-1 space-y-3">
            <div>
                <div class="flex items-start justify-between">
                    ...
                    @if($d->is_active)
                        <span class="bg-green-50 text-green-600 text-[10px] px-2.5 py-0.5 rounded-full font-semibold border border-green-100 uppercase tracking-widest">Published</span>
                    @else
                        <span class="bg-gray-100 text-gray-500 text-[10px] px-2.5 py-0.5 rounded-full font-semibold border border-gray-200 uppercase tracking-widest">Draft</span>
                    @endif
                </div>
            ...
            <div class="flex flex-wrap items-center gap-4 text-xs text-gray-400">
                <div class="flex items-center gap-1.5">
                    ...
                    <span>{{ $d->kategori->nama_kategori ?? 'Umum' }}</span>
                </div>
                <div class="flex items-center gap-1.5">
                    ...
                    <span class="truncate max-w-[200px] md:max-w-[400px]">{{ $d->original_filename ?: $d->judul_dokumen . '.pdf' }}</span>
                </div>
                <div class="flex items-center gap-1.5">
    ...
    @empty
        <div class="text-center py-12">
            ...
            <h3 class="text-gray-900 font-medium">Belum ada dokumen</h3>
            <p class="text-gray-500 text-sm">Silakan tambahkan dokumen baru.</p>
        </div>
    @endforelse
</div>
